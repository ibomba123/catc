   ...
   <form id="filterFrm" name="filterFrm">
     ...
     <div class="row">
       ...
       <div class="col-xs-4">
         <div class="row">
           <div class="col-xs-5">
             <label for="year">ประเภทของงาน : </label>
           </div>
           <div class="col-xs-5">
             <select title="ทั้งหมด" name="process[]" class="selectpicker show-tick"  data-actions-box="true" id="process" multiple>
               <?php
     ...
     <div class="row">
       <div class="col-xs-4">
         <div class="row">
           <div class="col-xs-5">
             <label for="year">พนักงานพิมพ์ : </label>
           </div>
           <div class="col-xs-5">
             <select title="ทั้งหมด" name="worker[]" class="selectpicker show-tick"  data-actions-box="true" id="worker" multiple>
               <?php
